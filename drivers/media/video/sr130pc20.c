...
#define isx012_readb(sd, addr, data) (0)
#define isx012_writeb(sd, addr, data) (0)

#define sr130pc20_readb(sd, addr, data) sr130pc20_i2c_read(sd, addr, data)
#define sr130pc20_readw(sd, addr, data) (0)
#define sr130pc20_readl(sd, addr, data) (0)
#define sr130pc20_writeb(sd, addr, data) sr130pc20_i2c_write(sd, addr, data)
#define sr130pc20_writew(sd, addr, data) (0)
#define sr130pc20_writel(sd, addr, data) (0)
#define sr130pc20_wait_ae_stable_af(sd)	sr130pc20_wait_ae_stable(sd, true, false)
#define sr130pc20_wait_ae_stable_preview(sd) sr130pc20_wait_ae_stable(sd, false, true)
#define sr130pc20_wait_ae_stable_cap(sd)	sr130pc20_wait_ae_stable(sd, false, false)
...
static const struct sr130pc20_regs reg_datas = {
	...
	.saturation = {
		SR130PC20_REGSET(SATURATION_MINUS_2, sr130pc20_Saturation_Minus_2, 0),
		SR130PC20_REGSET(SATURATION_MINUS_1, sr130pc20_Saturation_Minus_1, 0),
		SR130PC20_REGSET(SATURATION_DEFAULT, sr130pc20_Saturation_Default, 0),
		SR130PC20_REGSET(SATURATION_PLUS_1, sr130pc20_Saturation_Plus_1, 0),
		SR130PC20_REGSET(SATURATION_PLUS_2, sr130pc20_Saturation_Plus_2, 0),
	},
	.contrast = {
		SR130PC20_REGSET(CONTRAST_MINUS_2, sr130pc20_Contrast_Minus_2, 0),
		SR130PC20_REGSET(CONTRAST_MINUS_1, sr130pc20_Contrast_Minus_1, 0),
		SR130PC20_REGSET(CONTRAST_DEFAULT, sr130pc20_Contrast_Default, 0),
		SR130PC20_REGSET(CONTRAST_PLUS_1, sr130pc20_Contrast_Plus_1, 0),
		SR130PC20_REGSET(CONTRAST_PLUS_2, sr130pc20_Contrast_Plus_2, 0),

	},
	.sharpness = {
		SR130PC20_REGSET(SHARPNESS_MINUS_2, sr130pc20_Sharpness_Minus_2, 0),
		SR130PC20_REGSET(SHARPNESS_MINUS_1, sr130pc20_Sharpness_Minus_1, 0),
		SR130PC20_REGSET(SHARPNESS_DEFAULT, sr130pc20_Sharpness_Default, 0),
		SR130PC20_REGSET(SHARPNESS_PLUS_1, sr130pc20_Sharpness_Plus_1, 0),
		SR130PC20_REGSET(SHARPNESS_PLUS_2, sr130pc20_Sharpness_Plus_2, 0),
	},
	.fps = {
	...
	.preview_size = {
		SR130PC20_REGSET(PREVIEW_SZ_320x240, sr130pc20_320_Preview, 0),
	...
	|| defined(CONFIG_MACH_P4NOTELTE_KOR_LGT) /*For 4G VT call in Domestic*/
		SR130PC20_REGSET(PREVIEW_SZ_VERTICAL_VGA, sr130pc20_480_Preview, 0),
#endif
		SR130PC20_REGSET(PREVIEW_SZ_VGA, sr130pc20_640_Preview, 0),
		SR130PC20_REGSET(PREVIEW_SZ_D1, sr130pc20_720_Preview, 0),
		SR130PC20_REGSET(PREVIEW_SZ_XGA, sr130pc20_1024_768_Preview, 0),
		SR130PC20_REGSET(PREVIEW_SZ_PVGA, sr130pc20_1280_Preview_E, 0),
	},
	.capture_size = {
		SR130PC20_REGSET(CAPTURE_SZ_VGA, sr130pc20_VGA_Capture, 0),
		SR130PC20_REGSET(CAPTURE_SZ_960_720, sr130pc20_960_720_Capture, 0),
		SR130PC20_REGSET(CAPTURE_SZ_3MP, sr130pc20_3M_Capture, 0),
		SR130PC20_REGSET(CAPTURE_SZ_5MP, sr130pc20_5M_Capture, 0),
	},

	/* AF */
	.af_window_reset = SR130PC20_REGSET_TABLE(SR130PC20_AF_Window_Reset, 1),
	.af_winddow_set = SR130PC20_REGSET_TABLE(SR130PC20_AF_Window_Set, 0),
	.af_restart = SR130PC20_REGSET_TABLE(SR130PC20_AF_ReStart, 0),
	.af_saf_off = SR130PC20_REGSET_TABLE(SR130PC20_AF_SAF_OFF, 0),
	.af_touch_saf_off = SR130PC20_REGSET_TABLE(SR130PC20_AF_TouchSAF_OFF, 0),
	.cancel_af_macro = SR130PC20_REGSET_TABLE(SR130PC20_AF_Cancel_Macro_ON, 0),
	.cancel_af_normal = SR130PC20_REGSET_TABLE(SR130PC20_AF_Cancel_Macro_OFF, 0),
	.af_macro_mode = SR130PC20_REGSET_TABLE(SR130PC20_AF_Macro_ON, 0),
	.af_normal_mode = SR130PC20_REGSET_TABLE(SR130PC20_AF_Macro_OFF, 0),
	.af_camcorder_start = SR130PC20_REGSET_TABLE(
				SR130PC20_Camcorder_SAF_Start, 0),

	/* Flash */
	.flash_ae_line = SR130PC20_REGSET_TABLE(SR130PC20_Flash_AELINE, 0),
	.flash_on = SR130PC20_REGSET_TABLE(SR130PC20_Flash_ON, 1),
	.flash_off = SR130PC20_REGSET_TABLE(SR130PC20_Flash_OFF, 1),
	.ae_manual = SR130PC20_REGSET_TABLE(SR130PC20_ae_manual_mode, 0),
	.flash_fast_ae_awb = SR130PC20_REGSET_TABLE(SR130PC20_flash_fast_ae_awb, 0),
#endif
	...
	.halfrelease_mode = SR130PC20_REGSET_TABLE(SR130PC20_Halfrelease_Mode, 0),
	.halfrelease_mode_night =
		SR130PC20_REGSET_TABLE(SR130PC20_Lowlux_night_Halfrelease_Mode, 0),
	.camcorder_on = SR130PC20_REGSET_TABLE(SR130PC20_Camcorder_Mode_ON, 1),
	.camcorder_off = SR130PC20_REGSET_TABLE(SR130PC20_Camcorder_Mode_OFF, 1),

	.lowlux_night_reset = SR130PC20_REGSET_TABLE(SR130PC20_Lowlux_Night_Reset, 0),

	.set_pll_4 = SR130PC20_REGSET_TABLE(SR130PC20_Pll_Setting_4, 1),
	.shading_0 = SR130PC20_REGSET_TABLE(SR130PC20_Shading_0, 1),
	.shading_1 = SR130PC20_REGSET_TABLE(SR130PC20_Shading_1, 1),
	.shading_2 = SR130PC20_REGSET_TABLE(SR130PC20_Shading_2, 1),
	.shading_nocal = SR130PC20_REGSET_TABLE(SR130PC20_Shading_Nocal, 1),
	.softlanding = SR130PC20_REGSET_TABLE(SR130PC20_Sensor_Off_VCM, 0),
#endif
	.stream_stop = SR130PC20_REGSET_TABLE(sr130pc20_stop_stream, 0),

#if 0 /* def CONFIG_VIDEO_SR130PC20_P8*/
	.antibanding = SR130PC20_REGSET_TABLE(SR130PC20_ANTIBANDING_REG, 0),
#endif
};
...
static int sr130pc20_is_om_changed(struct v4l2_subdev *sd)
{
	...
	for (cnt1 = 0; cnt1 < SR130PC20_CNT_OM_CHECK; cnt1++) {
	...
	for (cnt2 = 0; cnt2 < SR130PC20_CNT_OM_CHECK; cnt2++) {
...
/**
 * sr130pc20_is_cm_changed:
 *
 * status: 0x01 = int check fail
 *       0x02 = int clear fail
 *       0x03 = int check, clear fail
 */
static int sr130pc20_is_cm_changed(struct v4l2_subdev *sd)
{
	u32 status = 0x3, val = 0;
	int err = 0, cnt1, cnt2;

	for (cnt1 = 0; cnt1 < SR130PC20_CNT_CM_CHECK; cnt1++) {
		err = isx012_readb(sd, REG_INTSTS, &val);
	...
	for (cnt2 = 0; cnt2 < SR130PC20_CNT_CM_CHECK; cnt2++) {
...
static inline int sr130pc20_transit_preview_mode(struct v4l2_subdev *sd)
{
	...
	sr130pc20_restore_sensor_flash(sd);

	if (state->exposure.ae_lock || state->wb.awb_lock)
		cam_info("Restore user ae(awb)-lock...\n");

	return sr130pc20_set_from_table(sd, "preview_mode",
		&state->regs->preview_mode, 1, 0);
}

/**
 * sr130pc20_transit_half_mode: go to a half-release mode
 * Don't forget that half mode is not used in movie mode.
 */
static inline int sr130pc20_transit_half_mode(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = -EIO;
	...
	if (state->scene_mode == SCENE_MODE_NIGHTSHOT &&
		...
		err = sr130pc20_set_from_table(sd, "night_halfrelease_mode",
			&state->regs->halfrelease_mode_night, 1, 0);
	} else {
		state->capture.lowlux_night = 0;
		err = sr130pc20_set_from_table(sd, "halfrelease",
...
static inline int sr130pc20_transit_movie_mode(struct v4l2_subdev *sd)
{
	...
	case RUNMODE_RUNNING_STOP:
		...
		if (state->sensor_mode == SENSOR_MOVIE) {
			...
			sr130pc20_set_from_table(sd, "camcorder_on",
	...
	case RUNMODE_RECORDING_STOP:
		...
		if (state->sensor_mode == SENSOR_CAMERA) {
			...
			sr130pc20_set_from_table(sd, "camcorder_off",
...
static void sr130pc20_frame_checker(struct work_struct *work)
{
	struct sr130pc20_state *state = container_of(work, \
			struct sr130pc20_state, frame_work);
	...
	for (cnt = 0; cnt < SR130PC20_CNT_CAPTURE_FRM; cnt++) {
		err = isx012_readb(sd, REG_INTSTS, &val);
		if (unlikely(err)) {
...
static int sr130pc20_start_frame_checker(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int cnt, err = 0;
	u32 val = 0;
	...
	for (cnt = 0; cnt < SR130PC20_CNT_CLEAR_VINT; cnt++) {
		isx012_writeb(sd, REG_INTCLR, mask);
		isx012_readb(sd, REG_INTSTS, &val);
		if (((u8)val & mask) == 0)
			break;
	...
	if (unlikely(cnt >= SR130PC20_CNT_CLEAR_VINT)) {
...
static void sr130pc20_frame_checker(struct work_struct *work)
{
	...
	for (cnt = 0; cnt < SR130PC20_CNT_CAPTURE_FRM; cnt++) {
		...
		if (((u8)val & SR130PC20_INTSRC_VINT) == SR130PC20_INTSRC_VINT) {
			++int_cnt;
			...
			isx012_writeb(sd, REG_INTCLR, SR130PC20_INTSRC_VINT);
			isx012_readb(sd, REG_INTSTS, &val);
			if (((u8)val & SR130PC20_INTSRC_VINT) != 0) {
				cam_info("frame_checker: cannot clear int");
				return;
			}
		}
...
static void sr130pc20_stop_frame_checker(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
					...
					u32 *light_level)
{
	...
	if (state->iso == ISO_AUTO)
		...
		sr130pc20_readw(sd, REG_SHT_TIME_OUT_L, &val_lsb);
		sr130pc20_readw(sd, REG_SHT_TIME_OUT_H, &val_msb);
...
static int sr130pc20_set_capture_size(struct v4l2_subdev *sd)
{
	...
	sr130pc20_writew(sd, REG_HSIZE_CAP, width);
	sr130pc20_writew(sd, REG_VSIZE_CAP, height);
...
static int sr130pc20_set_ae_lock(struct v4l2_subdev *sd, s32 lock, bool force)
{
	struct sr130pc20_state *state = to_state(sd);
	u32 val = 0;
...
static int sr130pc20_set_awb_lock(struct v4l2_subdev *sd, s32 lock, bool force)
{
	struct sr130pc20_state *state = to_state(sd);
	u32 val = 0;
...
/* PX: Set AE, AWB Lock */
static int sr130pc20_set_lock(struct v4l2_subdev *sd, s32 lock, bool force)
{
#if 0
	int err = -EIO;
	...
	err = sr130pc20_set_ae_lock(sd, (lock == AEAWB_LOCK) ?
				AE_LOCK : AE_UNLOCK, force);
	if (unlikely(err))
		goto out_err;

	err = sr130pc20_set_awb_lock(sd, (lock == AEAWB_LOCK) ?
...
static int sr130pc20_set_af_softlanding(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = -EINVAL;

	err = sr130pc20_set_from_table(sd, "softlanding",
...
/* PX: */
static int sr130pc20_return_focus(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = -EINVAL;
	...
	if (state->focus.mode == FOCUS_MODE_MACRO)
		err = sr130pc20_set_from_table(sd, "af_macro_mode",
				&state->regs->af_macro_mode, 1, 0);
	else
		err = sr130pc20_set_from_table(sd, "af_normal_mode",
...
static int sr130pc20_pre_sensor_flash(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	...
	sr130pc20_set_from_table(sd, "flash_ae_line",
	...
	sr130pc20_readw(sd, REG_USER_AESCL_AUTO,
		&state->flash.ae_offset.ae_auto);
	sr130pc20_readw(sd, REG_ERRSCL_AUTO, &state->flash.ae_offset.ersc_auto);

	if (state->wb.mode == WHITE_BALANCE_AUTO)
		isx012_writeb(sd, REG_AWB_SN1, 0x00);

	/* write flash_on_set */
	sr130pc20_set_from_table(sd, "flash_on",
...
static int sr130pc20_post_sensor_flash(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);

	cam_trace("EX\n");

	sr130pc20_set_from_table(sd, "flash_off",
...
static inline int sr130pc20_restore_sensor_flash(struct v4l2_subdev *sd)
{
	...
	return sr130pc20_post_sensor_flash(sd);
}

static int sr130pc20_wait_ae_stable(struct v4l2_subdev *sd,
				bool af_doing, bool long_wait)
{
	...
	if (af_doing || long_wait)
		max_1st = max_2nd = SR130PC20_CNT_AE_STABLE;
	else {
...
static bool sr130pc20_check_flash_fire(struct v4l2_subdev *sd, u32 light_level)
{
	struct sr130pc20_state *state = to_state(sd);
...
static int sr130pc20_cancel_af(struct v4l2_subdev *sd, bool flash)
{
	struct sr130pc20_state *state = to_state(sd);

	if (state->focus.mode == FOCUS_MODE_MACRO)
		sr130pc20_set_from_table(sd, "cancel_af_macro",
			&state->regs->cancel_af_macro, 1, 0);
	else
		sr130pc20_set_from_table(sd, "cancel_af_normal",
			&state->regs->cancel_af_normal, 1, 0);

	if (flash)
		sr130pc20_post_sensor_flash(sd);

	return 0;
}

/* PX: Prepare AF Flash */
static int sr130pc20_af_start_preflash(struct v4l2_subdev *sd,
				u32 touch, u32 flash_mode)
{
	...
	if (!touch)
		sr130pc20_set_from_table(sd, "af_window_reset",
			&state->regs->af_window_reset, 1, 0);

	sr130pc20_get_light_level(sd, &state->light_level);

	switch (flash_mode) {
	case FLASH_MODE_AUTO:
		if (!sr130pc20_check_flash_fire(sd, state->light_level))
			break;

	case FLASH_MODE_ON:
		flash = true;
		state->flash.preflash = PREFLASH_ON;
		sr130pc20_pre_sensor_flash(sd);
...
static int sr130pc20_do_af(struct v4l2_subdev *sd, u32 touch)
{
	struct sr130pc20_state *state = to_state(sd);
	u32 read_value = 0;
	u32 count = 0;
	...
	if (state->sensor_mode == SENSOR_MOVIE) {
		sr130pc20_set_from_table(sd, "af_camcorder_start",
			&state->regs->af_camcorder_start, 1, 0);
	} else if (!flash)
		sr130pc20_transit_half_mode(sd);
...
check_fail:
	if (flash) {
		sr130pc20_readw(sd, REG_ERRSCL_NOW,
			&state->flash.ae_offset.ersc_now);
		sr130pc20_readw(sd, REG_USER_AESCL_NOW,
			&state->flash.ae_offset.ae_now);
		sr130pc20_readw(sd, REG_AESCL, &state->flash.ae_scl);
	}

	if (touch)
		sr130pc20_set_from_table(sd, "af_touch_saf_off",
			&state->regs->af_touch_saf_off, 1, 0);
	else
		sr130pc20_set_from_table(sd, "af_saf_off",
	...
	if (flash) {
		sr130pc20_writew(sd, REG_MANOUTGAIN,
			(u16)(state->flash.ae_scl - AE_SCL_SUBRACT_VALUE));
		/*sr130pc20_set_ae_gainoffset(sd);*/
		sr130pc20_flash_torch(sd, SR130PC20_FLASH_OFF);
...
/* PX: Set AF */
static int sr130pc20_set_af(struct v4l2_subdev *sd, s32 val)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = 0;
...
static int sr130pc20_start_af(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = 0;
	...
	if (state->sensor_mode == SENSOR_CAMERA) {
		err = sr130pc20_af_start_preflash(sd, touch, flash_mode);
		if (unlikely(err))
			goto out;
...
/* PX: Stop AF */
static int sr130pc20_stop_af(struct v4l2_subdev *sd, s32 touch)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = 0;
	bool flash;
...
static void sr130pc20_af_worker(struct work_struct *work)
{
	struct sr130pc20_state *state = container_of(work, \
			struct sr130pc20_state, af_work);

	sr130pc20_start_af(&state->sd);
}

/* PX: Set focus mode */
static int sr130pc20_set_focus_mode(struct v4l2_subdev *sd, s32 val)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = -EINVAL;
	u32 cancel = 0;
	...
	if (cancel)
		sr130pc20_stop_af(sd, 0);

	/* check focus mode of lower byte  */
	switch (focus_mode) {
	case FOCUS_MODE_MACRO:
		sr130pc20_set_from_table(sd, "af_macro_mode",
			&state->regs->af_macro_mode, 1, 0);
		if (!cancel)
			sr130pc20_set_from_table(sd, "af_restart",
	...
	case FOCUS_MODE_FIXED:
		sr130pc20_set_from_table(sd, "af_normal_mode",
			&state->regs->af_normal_mode, 1, 0);
		if (!cancel)
			sr130pc20_set_from_table(sd, "af_restart",
				&state->regs->af_restart, 1, 0);
...
/* PX: */
static int sr130pc20_set_af_window(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	...
	struct sr130pc20_rect window = {0, 0, 0, 0};
	...
	sr130pc20_writew(sd, 0x6A50, window.x);
	sr130pc20_writew(sd, 0x6A52, window.y);
	sr130pc20_writew(sd, 0x6A54, window.width);
	sr130pc20_writew(sd, 0x6A56, window.height);
	sr130pc20_set_from_table(sd, "af_winddow_set",
...
static int sr130pc20_set_touch_af(struct v4l2_subdev *sd, s32 val)
{
	struct sr130pc20_state *state = to_state(sd);
	int err = -EIO;
...
static void sr130pc20_af_win_worker(struct work_struct *work)
{
	struct sr130pc20_state *state = container_of(work, \
				struct sr130pc20_state, af_win_work);
	struct v4l2_subdev *sd = &state->sd;

	sr130pc20_set_af_window(sd);
}
...
static int sr130pc20_check_esd(struct v4l2_subdev *sd, s32 val)
{
	...
	sr130pc20_readw(sd, REG_ESD, &data);
#if 0 /* dslim */
	if (data != ESD_VALUE)
		goto esd_out;
#endif

	sr130pc20_readw(sd, REG_HSIZE_MONI, &size_h);
	sr130pc20_readw(sd, REG_VSIZE_MONI, &size_v);
	cam_info("preview size %dx%d\n", size_h, size_v);

	sr130pc20_readw(sd, REG_HSIZE_CAP, &size_h);
	sr130pc20_readw(sd, REG_VSIZE_CAP, &size_v);
...
/* for debugging */
static int sr130pc20_check_preview_status(struct v4l2_subdev *sd)
{
	u32 reg_val1 = 0;
	u32 reg_val4 = 0;
	u32 reg_val7 = 0;
...
static int sr130pc20_set_preview_size(struct v4l2_subdev *sd)
{
	...
	sr130pc20_writew(sd, REG_HSIZE_MONI, width);
	sr130pc20_writew(sd, REG_VSIZE_MONI, height);
...
static int sr130pc20_start_preview(struct v4l2_subdev *sd)
{
	...
	if (state->runmode == RUNMODE_CAPTURING_STOP) {
		if (state->scene_mode == SCENE_MODE_NIGHTSHOT)
			sr130pc20_set_from_table(sd, "night_reset",
...
#ifdef CONFIG_DEBUG_NO_FRAME
	sr130pc20_start_frame_checker(sd);
#endif
#endif
...
static int sr130pc20_set_capture(struct v4l2_subdev *sd)
{
	...
	if (state->capture.ae_manual_mode) {
		...
		sr130pc20_readw(sd, REG_AESCL, &ae_scl);
		...
		sr130pc20_set_from_table(sd, "ae_manual_mode",
			&state->regs->ae_manual, 1, 0);
	}

	/* Set capture size */
	err = sr130pc20_set_capture_size(sd);
	...
	case FLASH_MODE_AUTO:
		...
		if (state->flash.preflash == PREFLASH_NONE) {
			sr130pc20_get_light_level(sd, &lux);
			if (!sr130pc20_check_flash_fire(sd, lux))
				break;
	...
	case FLASH_MODE_ON:
		sr130pc20_flash_oneshot(sd, SR130PC20_FLASH_ON);

		if (unlikely(state->flash.preflash != PREFLASH_ON)) {
			cam_warn("warning: Flash capture without preflash!!\n\n");
			sr130pc20_set_from_table(sd, "flash_fast_ae_awb",
				&state->regs->flash_fast_ae_awb, 1, 0);
			sr130pc20_wait_ae_stable_cap(sd);
...
static int sr130pc20_start_capture(struct v4l2_subdev *sd)
{
	...
	if (!state->capture.ready) {
		...
		err = sr130pc20_is_cm_changed(sd);
		CHECK_ERR(err);
	...
	if (state->flash.on && (state->wb.mode == WHITE_BALANCE_AUTO)) {
		...
		for (count = 0; count < SR130PC20_CNT_CAPTURE_AWB; count++) {
		...
		if (unlikely(count >= SR130PC20_CNT_CAPTURE_AWB))
...
static int sr130pc20_init_regs(struct v4l2_subdev *sd)
{
	...
	isx012_readb(sd, 0x04, &read_value);
	if (likely(SR130PC20_CHIP_ID == read_value))
...
static int sr130pc20_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	case V4L2_CID_CAMERA_TOUCH_AF_START_STOP:
		err = sr130pc20_set_touch_af(sd, ctrl->value);
		break;

	case V4L2_CID_CAMERA_FOCUS_MODE:
		err = sr130pc20_set_focus_mode(sd, ctrl->value);
		break;

	case V4L2_CID_CAMERA_SET_AUTO_FOCUS:
		err = sr130pc20_set_af(sd, ctrl->value);
		break;
	...
	case V4L2_CID_CAMERA_SATURATION:
		err = sr130pc20_set_from_table(sd, "saturation",
			state->regs->saturation,
			ARRAY_SIZE(state->regs->saturation), ctrl->value);
		break;

	case V4L2_CID_CAMERA_SHARPNESS:
		err = sr130pc20_set_from_table(sd, "sharpness",
	...
	case V4L2_CID_CAMERA_AE_LOCK_UNLOCK:
		err = sr130pc20_set_ae_lock(sd, ctrl->value, false);
		break;

	case V4L2_CID_CAMERA_AWB_LOCK_UNLOCK:
		err = sr130pc20_set_awb_lock(sd, ctrl->value, false);
		break;
...
void sr130pc20_Sensor_Calibration(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int status = 0;
	int temp = 0;
	...
	/* Read OTP1 */
	sr130pc20_readw(sd, 0x004F, &status);
	boot_dbg("Cal: 0x004F read %x\n", status);

	if ((status & 0x10) == 0x10) {
		/* Read ShadingTable */
		sr130pc20_readw(sd, 0x005C, &status);
		temp = (status&0x03C0)>>6;
		boot_dbg("Cal: Read ShadingTable [0x%x]\n", temp);

		/* Write Shading Table */
		if (temp == 0x0)
			sr130pc20_set_from_table(sd, "Shading_0",
			       &state->regs->shading_0, 1, 0);
		else if (temp == 0x1)
			sr130pc20_set_from_table(sd, "Shading_1",
			       &state->regs->shading_1, 1, 0);
		else if (temp == 0x2)
			sr130pc20_set_from_table(sd, "Shading_2",
			       &state->regs->shading_2, 1, 0);

		/* Write NorR */
		sr130pc20_readw(sd, 0x0054, &status);
		temp = status&0x3FFF;
		boot_dbg("Cal: NorR read : %x\n", temp);
		sr130pc20_writew(sd, 0x6804, temp);

		/* Write NorB */
		sr130pc20_readw(sd, 0x0056, &status);
		temp = status&0x3FFF;
		boot_dbg("Cal: NorB read : %x\n", temp);
		sr130pc20_writew(sd, 0x6806, temp);

		/* Write PreR */
		sr130pc20_readw(sd, 0x005A, &status);
		temp = (status&0x0FFC)>>2;
		boot_dbg("Cal: PreR read : %x\n", temp);
		sr130pc20_writew(sd, 0x6808, temp);

		/* Write PreB */
		sr130pc20_readw(sd, 0x005B, &status);
		temp = (status&0x3FF0)>>4;
		boot_dbg("Cal: PreB read : %x\n", temp);
		sr130pc20_writew(sd, 0x680A, temp);
	} else {
		/* Read OTP0 */
		sr130pc20_readw(sd, 0x0040, &status);
		boot_dbg("Cal: 0x0040 read : %x\n", status);

		if ((status & 0x10) == 0x10) {
			/* Read ShadingTable */
			sr130pc20_readw(sd, 0x004D, &status);
			temp = (status&0x03C0)>>6;
			boot_dbg("Cal: Read ShadingTable [0x%x]\n", temp);
			...
			/* Write NorR */
			sr130pc20_readw(sd, 0x0045, &status);
			temp = status&0x3FFF;
			boot_dbg("Cal: NorR read : %x\n", temp);
			sr130pc20_writew(sd, 0x6804, temp);

			/* Write NorB */
			sr130pc20_readw(sd, 0x0047, &status);
			temp = status&0x3FFF;
			boot_dbg("Cal: NorB read : %x\n", temp);
			sr130pc20_writew(sd, 0x6806, temp);

			/* Write PreR */
			sr130pc20_readw(sd, 0x004B, &status);
			temp = (status&0x0FFC)>>2;
			boot_dbg("Cal: PreR read : %x\n", temp);
			sr130pc20_writew(sd, 0x6808, temp);

			/* Write PreB */
			sr130pc20_readw(sd, 0x004C, &status);
			temp = (status&0x3FF0)>>4;
			boot_dbg("Cal: PreB read : %x\n", temp);
			sr130pc20_writew(sd, 0x680A, temp);
		} else
			sr130pc20_set_from_table(sd, "Shading_nocal",
...
static int sr130pc20_post_poweron(struct v4l2_subdev *sd)
{
	struct sr130pc20_state *state = to_state(sd);
	int err;
	...
	err = sr130pc20_check_i2c(sd, 0x1234);
	if (err) {
	...
	msleep_debug(10, false);
	err = sr130pc20_is_om_changed(sd);
	CHECK_ERR(err);

	/* Pre-Sleep */
	cam_dbg("=== Bootup: pre-sleep mode ===\n");
	sr130pc20_set_from_table(sd, "set_pll_4",
	...
	sr130pc20_Sensor_Calibration(sd);
...
static int sr130pc20_init(struct v4l2_subdev *sd, u32 val)
{
	...
	sr130pc20_set_from_table(sd, "antibanding",
	...
	sr130pc20_control_stream(sd, STREAM_STOP); /* dslim temp */
...
#ifdef CONFIG_DEBUG_NO_FRAME
	INIT_WORK(&state->frame_work, sr130pc20_frame_checker);
#endif
...
static int sr130pc20_remove(struct i2c_client *client)
{
	...
	/* do softlanding */
	if (state->initialized)
		sr130pc20_set_af_softlanding(sd);
...
static int sr130pc20_create_dbglogfile(struct class *cls)
{
	...
	if (unlikely(!dev)) {
		pr_info("[SR130PC20] can not find rear device\n");
		return 0;
	}
